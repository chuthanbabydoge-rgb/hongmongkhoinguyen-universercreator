...
export const worldTerrainTypeEnum = pgEnum("world_terrain_type", [
  "flat",
  "hills",
  "mountains",
  "ocean",
...
export const creatorWorldRegions = pgTable("creator_world_regions", {
  ...
  terrain: worldTerrainTypeEnum("world_terrain_type").notNull().default("flat"),
  graphId: integer("graph_id"),
...
export const creatorWorldChunks = pgTable("creator_world_chunks", {
  ...
  chunkState: text("chunk_state").notNull().default("unloaded"),
